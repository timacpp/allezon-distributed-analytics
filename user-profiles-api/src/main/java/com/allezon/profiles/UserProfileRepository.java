...
import com.allezon.core.aerospike.AerospikeRepository;
...
@Repository
public class UserProfileRepository extends AerospikeRepository<UserProfile> {
	...
	public UserProfileRepository(@Value("${aerospike.seeds}") String[] seeds, @Value("${aerospike.port}") int port) {
	...
	public void update(String cookie, UserTag userTag) {
